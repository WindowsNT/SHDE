...
function PrepareDatabase()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS DVG (ID INTEGER PRIMARY KEY,DID INTEGER,MID INTEGER,DECISIONTYPE TEXT,UNIT INTEGER,SIGNER INTEGER,RESPONSE TEXT,FOREIGN KEY (DID) REFERENCES DOCUMENTS(ID),FOREIGN KEY (MID) REFERENCES MESSAGES(ID))");
}
...
function PrepareDatabaseMySQL()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS DVG (ID INTEGER PRIMARY KEY AUTO_INCREMENT,DID INTEGER,MID INTEGER,DECISIONTYPE TEXT,UNIT INTEGER,SIGNER INTEGER,RESPONSE TEXT,FOREIGN KEY (DID) REFERENCES DOCUMENTS(ID),FOREIGN KEY (MID) REFERENCES MESSAGES(ID))");
}
