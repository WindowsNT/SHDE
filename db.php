...
function PrepareDatabase()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS LOCKERS (ID INTEGER PRIMARY KEY,OID INTEGER,EID INTEGER,NAME TEXT,FOREIGN KEY (OID) REFERENCES ORGANIZATIONS(ID),FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID))");
    QQ("CREATE TABLE IF NOT EXISTS FOLDERS (ID INTEGER PRIMARY KEY,EID INTEGER,LID INTEGER,SPECIALID INTEGER,NAME TEXT,PARENT INTEGER,CLASSIFIED INTEGER,FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID),FOREIGN KEY (LID) REFERENCES LOCKERS(ID))");
    ...
    QQ("CREATE TABLE IF NOT EXISTS USERSINLOCKER (ID INTEGER PRIMARY KEY,UID INTEGER,LID INTEGER,ACCESS INTEGER,FOREIGN KEY (UID) REFERENCES USERS(ID),FOREIGN KEY (LID) REFERENCES LOCKERS(ID))");
...
function PrepareDatabaseMySQL()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS LOCKERS (ID INTEGER PRIMARY KEY AUTO_INCREMENT,OID INTEGER,EID INTEGER,NAME TEXT,FOREIGN KEY (OID) REFERENCES ORGANIZATIONS(ID),FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID))");
    QQ("CREATE TABLE IF NOT EXISTS FOLDERS (ID INTEGER PRIMARY KEY AUTO_INCREMENT,EID INTEGER,LID INTEGER,SPECIALID INTEGER,NAME TEXT,PARENT INTEGER,CLASSIFIED INTEGER,FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID),FOREIGN KEY (LID) REFERENCES LOCKERS(ID))");
    ...
    QQ("CREATE TABLE IF NOT EXISTS USERSINLOCKER (ID INTEGER PRIMARY KEY AUTO_INCREMENT,UID INTEGER,LID INTEGER,ACCESS INTEGER,FOREIGN KEY (UID) REFERENCES USERS(ID),FOREIGN KEY (LID) REFERENCES LOCKERS(ID))");
...
function CreateSpecialFoldersForLocker($eid)
{
    if (!QQ("SELECT * FROM FOLDERS WHERE LID = ?",array($eid))->fetchArray())
    {
        QQ("INSERT INTO FOLDERS (LID,SPECIALID,NAME) VALUES (?,?,?)",array($eid,FOLDER_INBOX,"Εισερχόμενα"));
        QQ("INSERT INTO FOLDERS (LID,SPECIALID,NAME) VALUES (?,?,?)",array($eid,FOLDER_OUTBOX,"Εξερχόμενα"));
        QQ("INSERT INTO FOLDERS (LID,SPECIALID,NAME) VALUES (?,?,?)",array($eid,FOLDER_SENT,"Απεσταλμένα"));
        QQ("INSERT INTO FOLDERS (LID,SPECIALID,NAME) VALUES (?,?,?)",array($eid,FOLDER_TRASH,"Trash"));
        QQ("INSERT INTO FOLDERS (LID,SPECIALID,NAME) VALUES (?,?,?)",array($eid,FOLDER_ARCHIVE,"Αρχείο"));
    }
}
