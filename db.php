...
function PrepareDatabase()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS ATTACHMENTS (ID INTEGER PRIMARY KEY,MID INTEGER,NAME TEXT,TYPE TEXT,DESC TEXT,DATA BLOB,SHDEID TEXT,FOREIGN KEY (MID) REFERENCES MESSAGES(ID))");
    ...
    QQ("CREATE TABLE IF NOT EXISTS LOGS (ID INTEGER PRIMARY KEY,OID INTEGER,EID INTEGER,DATE IMTEGER,DESCRIPTION TEXT,FOREIGN KEY (OID) REFERENCES ORGANIZATIONS(ID),FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID))");
}
...
{
    // MySQL
    $mysqli = new mysqli($dbxx,"root","","db1");
    PrepareDatabase();
}
else
{
