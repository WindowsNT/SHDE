...
function PrepareDatabase()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS ORGCHART (ID INTEGER PRIMARY KEY,CODE TEXT,ROOTCODE TEXT,NAME TEXT,NAMEEN TEXT,ACTIVE INTEGER,SDDD INTEGER,PARENT INTEGER,FULLNAME TEXT,CODE2 TEXT)");
...
function PrepareDatabaseMySQL()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS ORGCHART (ID INTEGER PRIMARY KEY AUTO_INCREMENT,CODE TEXT,ROOTCODE TEXT,NAME TEXT,ACTIVE INTEGER,SDDD INTEGER,PARENT INTEGER,FULLNAME TEXT,CODE2 TEXT,PARAG INTEGER)");
