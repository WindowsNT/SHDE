...
function PrepareDatabase()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS LOCKERS (ID INTEGER PRIMARY KEY,EID INTEGER,NAME TEXT,FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID))");
...
function PrepareDatabaseMySQL()
{
    ...
    QQ("CREATE TABLE IF NOT EXISTS LOCKERS (ID INTEGER PRIMARY KEY AUTO_INCREMENT,EID INTEGER,NAME TEXT,FOREIGN KEY (EID) REFERENCES ENDPOINTS(ID))");
