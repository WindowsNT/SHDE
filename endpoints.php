...
function PrintEndpoints($oid)
{
    ...
    while($r = $q->fetchArray())
    {
        ...
        printf('<td>');
        if ($a == 2)
            printf('<a href="endpoints.php?eid=%s">Επεξεργασία</a> &mdash; <a href="folders.php?eid=%s">Φάκελοι</a> &mdash; <a href="rules.php?eid=%s">Κανόνες</a> &mdash; <a href="restrictions.php?eid=%s">Περιορισμοί</a>',$r['ID'],$r['ID'],$r['ID'],$r['ID']);
        if ($a == 2)
